...
function animate() {
  ...
  tl2.to('#car', 4, { scale: 1, rotation: 0.01, ease: "power1.in" }, 0);
...
function default_over(event) {
  TweenMax.to(["#cta-roll"], 0.3, { autoAlpha: 1, ease: Power1.easeOut, delay: 0 });
}

function default_out(event) {
  TweenMax.to(["#cta-roll"], 0.3, { autoAlpha: 0, ease: Power1.easeOut, delay: 0 });
}